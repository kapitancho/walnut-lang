...
/* @var callable(list<Type>, Type=): TupleType $Tuple */
/* @var callable(array<string, Type>, Type=): RecordType $Record */
...
$addVariable('fn1', $function($Any(), $Record([
	'x' => $Integer(),
	'y' => $String(),
	'z' => $Boolean()
]), $functionBody(
	$record([
		...
		'y' => $constant($string('abc')),
		'z' => $constant($boolean(true))
	])
)));

$addVariable('fn2', $function($Any(), $Map($Union([$Integer(),$String(), $Boolean()])), $functionBody(
	$record([
		'x' => $constant($integer(123)),
		'y' => $constant($string('abc')),
		'z' => $constant($boolean(true))
...
$addVariable('fn3', $function($Any(), $Record([
	'x' => $Integer(),
	'y' => $String(),
	'z' => $Boolean()
], $Integer()), $functionBody(
	$record([
		'x' => $constant($integer(123)),
		'y' => $constant($string('abc')),
		'z' => $constant($boolean(true)),
		'w' => $constant($integer(123))
	])
)));

$addVariable('fn11', $function($Any(), $Map($Union([$Integer(),$String(), $Boolean()]), 3), $functionBody(
	$call($var('fn3'), $constant($null()))
)));
