...
$addVariable('doubleValue', $function($Integer(), $Integer(), $functionBody(
	$method($var('#'), 'binaryPlus', $var('#'))
)));

$addVariable('main', $function($Any(), $String(), $functionBody(
	$sequence([
		$assign('x', $constant($list([$integer(1), $integer(3), $integer(8)]))),
		$assign('x', $method($var('x'), 'map', $var('doubleValue'))),
