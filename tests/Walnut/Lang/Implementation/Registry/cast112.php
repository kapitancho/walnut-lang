...
$addAlias('DatabaseConnectionSettings', $Record([
	'host' => $String(1),
	'database' => $String(1),
	'username' => $String(1),
	'password' => $String(1)
...
$addAtom('DatabaseOutpost');

$addMethod(
	$Atom('DatabaseOutpost'),
	'asDatabaseConnectionSettings',
	$Null(),
	null,
	$Alias('DatabaseConnectionSettings'),
	$functionBody(
		$constant($dict([
...
$addVariable('check', $function($Any(), $Map(), $functionBody(
	$method($constant($atom('DatabaseOutpost')), 'as', $constant($type($Alias('DatabaseConnectionSettings'))))
)));

$addVariable('main', $function($Array($String()), $String(), $functionBody(
	$sequence([
		$assign('x', $call($var('check'), $constant($null()))),
